...
fn wire_elevate_ls_command_impl(port_: MessagePort, password: impl Wire2Api<String> + UnwindSafe) {
    FLUTTER_RUST_BRIDGE_HANDLER.wrap(
        WrapInfo {
            debug_name: "elevate_ls_command",
            port: Some(port_),
            mode: FfiCallMode::Normal,
        },
        move || {
            let api_password = password.wire2api();
            move |task_callback| Ok(elevate_ls_command(api_password))
        },
    )
}

...
class NativeWire implements FlutterRustBridgeWireBase {
  ...
  void wire_get_username(
    int port_,
  ) {
    return _wire_get_username(
      port_,
    );
  }

  late final _wire_get_usernamePtr =
      _lookup<ffi.NativeFunction<ffi.Void Function(ffi.Int64)>>(
          'wire_get_username');
  late final _wire_get_username =
      _wire_get_usernamePtr.asFunction<void Function(int)>();

  void wire_determine_escalation_methods(
    int port_,
  ) {
    return _wire_determine_escalation_methods(
      port_,
    );
  }

  late final _wire_determine_escalation_methodsPtr =
      _lookup<ffi.NativeFunction<ffi.Void Function(ffi.Int64)>>(
          'wire_determine_escalation_methods');
  late final _wire_determine_escalation_methods =
      _wire_determine_escalation_methodsPtr.asFunction<void Function(int)>();
